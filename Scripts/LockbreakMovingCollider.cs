...
public class LockbreakMovingCollider : MonoBehaviour
{
    ...
    [SerializeField] LockbreakManager lockbreakManagerReference;
    [SerializeField] Animator lockbreakAnimator;
    [SerializeField] Animator GateAnimator;
    [SerializeField] GameObject LockbreakMinigameCanvas;
    ...
    private string LockbeakAnimatorTrigger = "Trigger";
    ...
    public void GameWon()
    {
        ...
        {
            case 1:
                AudioManager.PlayRandomSound(AudioManager.Instance.lockbreakHitSounds);
                lockbreakAnimator.SetTrigger(LockbeakAnimatorTrigger);
            ...
            case 3:
                ...
                Event.Invoke();
                AudioManager.PlayRandomSound(AudioManager.Instance.lockbreakHitSounds);
                AudioManager.PlayRandomSound(AudioManager.Instance.lockbreakWonSounds);
                AudioManager.PlayStingSound(AudioManager.Instance.lockbreakWonChainSound);

                AudioManager.Instance.stingSource.clip = null;
                if (GateAnimator != null)
                    GateAnimator.SetTrigger(LockbeakAnimatorTrigger);
    ...
    public IEnumerator WaitForSeconds()
    {
        ...
        if (!(gameCounter == hitCount))
        {
            ...
            lockbreakManagerReference.RandomizePosition();

        }
        else
        {
            LockbreakMinigameCanvas.SetActive(false);
        }
