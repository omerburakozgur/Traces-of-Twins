...
public class DNACollectPieces : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    [SerializeField] private DNACollectManagers dnaCollectManagerReference;
